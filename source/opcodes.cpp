...
//  name         instset prefix   format  dest.   source1 source2 source3 source4 link    options
   ...
   {0,           0x8D  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 96. Link to vfmaddsub132pd
   {0,           0x90  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 97. Link to vfmsubadd132pd
   {0,           0x87  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 98. Link to vfmadd132pd
   {0,           0x8A  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 99. Link to vfmadd132sd
   {0,           0x93  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 9A. Link to vfmsub132pd
   {0,           0x96  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 9B. Link to vfmsub132sd
   {0,           0x99  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 9C. Link to vfnmadd132pd
   {0,           0x9C  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 9D. Link to vfnmadd132sd
   {0,           0x9F  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 9E. Link to vfnmsub132pd
   {0,           0xA2  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 9F. Link to vfnmsub132sd
//  name         instset prefix   format  dest.   source1 source2 source3 source4 link    options
   ...
   {0,           0x8E  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 A6. Link to vfmaddsub213pd
   {0,           0x91  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 A7. Link to vfmsubadd213pd
   {0,           0x88  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 A8. Link to vfmadd213pd
   {0,           0x8B  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 A9. Link to vfmadd213sd
   {0,           0x94  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 AA. Link to vfmsub213pd
   {0,           0x97  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 AB. Link to vfmsub213sd
   {0,           0x9A  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 AC. Link to vfnmadd213pd
   {0,           0x9D  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 AD. Link to vfnmadd213sd
   {0,           0xA0  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 AE. Link to vfnmsub213pd
   {0,           0xA3  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 AF. Link to vfnmsub213sd
...
//  name         instset prefix   format  dest.   source1 source2 source3 source4 link    options
   ...
   {0,           0x8F  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 B6. Link to vfmaddsub231pd
   {0,           0x92  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 B7. Link to vfmsubadd231pd
   {0,           0x89  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 B8. Link to vfmadd231pd
   {0,           0x8C  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 B9. Link to vfmadd231sd
   {0,           0x95  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 BA. Link to vfmsub231pd
   {0,           0x98  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 BB. Link to vfmsub231sd
   {0,           0x9B  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 BC. Link to vfnmadd231pd
   {0,           0x9E  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 BD. Link to vfnmadd231sd
   {0,           0xA1  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 BE. Link to vfnmsub231pd
   {0,           0xA4  , 0x0    , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0C  , 0x0   },    // 0F 38 BF. Link to vfnmsub231sd
//  name         instset prefix   format  dest.   source1 source2 source3 source4 link    options
...
//  name         instset prefix   format  dest.   source1 source2 source3 source4 link    options
   {"vcvtps2ph", 0x19  , 0x78200, 0x52,   0x450 , 0x150 , 0x31  , 0x0   , 0x0   , 0x0   , 0x0   },    // 0F 3A 1D
...
//  name         instset prefix   format  dest.   source1 source2 source3 source4 link    options
   ...
   {"rdfsbase",  0x19  , 0x1400 , 0x11  , 0x1009, 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   },     // F3 0F AE m-0
   {"rdgsbase",  0x19  , 0x1400 , 0x11  , 0x1009, 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   },     // F3 0F AE m-1
   {"wrfsbase",  0x19  , 0x1400 , 0x11  , 0     , 0x1009, 0x0   , 0x0   , 0x0   , 0x0   , 0x0   },     // F3 0F AE m-2
   {"wrgsbase",  0x19  , 0x1400 , 0x11  , 0     , 0x1009, 0x0   , 0x0   , 0x0   , 0x0   , 0x0   },     // F3 0F AE m-3
   {0,           0x0   , 0x0    , 0x10  , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   },     // Illegal
...
// Opcode map for fxsave and rdfsbase instructions 0F AE /0
// Indexed by mem/reg
SOpcodeDef OpcodeMapAC[] = {
//  name         instset prefix   format  dest.   source1 source2 source3 source4 link    options
   {0,           0x52  , 0x0    , 0     , 0     , 0x0   , 0x0   , 0x0   , 0x0   , 0x9   , 0x0   },    // 0F C7 /6 mem link to vmptrld etc
   {"rdrand",    0x19  , 0x1100 , 0x11  , 0x1009, 0x0   , 0x0   , 0x0   , 0x0   , 0x0   , 0x0   }};   // 0F C7 /6 reg
